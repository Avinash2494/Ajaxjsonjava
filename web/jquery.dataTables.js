...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "No data available in tableNo data available in table or you have entered a course which is unavilable,please check suggestion for availavilabe coursesNo data available in table or you have entered a course which is unavilable,please check suggestion for availavilabe courses" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "No data available in table or you have entered a course which is unavilable,please check suggestion for availavilabe courses",
